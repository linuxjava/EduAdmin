  ...
  <div class="navbar">
    ...
    <div class="right-menu">
      <template v-if="device!=='mobile'">
        <search v-if="isShowMenu" id="header-search" class="right-menu-item" />
...
<!--        <el-tooltip v-if="isShowMenu" content="Global Size" effect="dark" placement="bottom">
      ...
      <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
        <div class="avatar-wrapper">
          <img :src="avatar || 'https://img.zcool.cn/community/01e4ea57a6e2550000018c1bfdce56.jpg'" class="user-avatar">
